...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestResource.resource_file'
        db.add_column(u'hs_test_app_testresource', 'resource_file',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'TestResource.resource_description'
        db.add_column(u'hs_test_app_testresource', 'resource_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestResource.resource_file'
        db.delete_column(u'hs_test_app_testresource', 'resource_file')

        # Deleting field 'TestResource.resource_description'
        db.delete_column(u'hs_test_app_testresource', 'resource_description')
    ...
    models = {
        ...
        u'hs_test_app.testresource': {
            ...
            'resource_file': ('django.db.models.fields.files.FileField', [], {'default': "''", 'max_length': '100'}),
