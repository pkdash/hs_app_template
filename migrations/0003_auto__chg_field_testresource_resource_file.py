...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestResource.resource_file'
        db.alter_column(u'hs_test_app_testresource', 'resource_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'TestResource.resource_file'
        db.alter_column(u'hs_test_app_testresource', 'resource_file', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'hs_test_app.testresource': {
            ...
            'resource_file': ('django.db.models.fields.files.FileField', [], {'default': "''", 'max_length': '100', 'null': 'True'}),
